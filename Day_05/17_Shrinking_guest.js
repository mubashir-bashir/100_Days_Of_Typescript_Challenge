...
console.log("\nSorry guys, ".concat(guest_list[cancelGuest], " can't make it for dinner."));
...
var middle = Math.floor(guest_list.length / 2);
...
guest_list.forEach(function (guest) { return console.log("".concat(guest, ", you're still invited.")); });
